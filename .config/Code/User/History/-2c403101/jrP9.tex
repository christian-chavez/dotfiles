...
\usepackage[skip=0.75\baselineskip]{parskip}

% Ambientes genéricos
% \newenvironment{<nombre>}[<num_args>]{<comienzo>}{<fin>}
\newenvironment{mi ambinte}[<num_args>]{<comienzo>}{<fin>}


% Ambientes propios, teoremas, etc

\newtheoremstyle{uptheorem}{\topsep}{\topsep}{\slshape}{}{\bfseries}{.}{ }{} % nuevo estilo de teorema
