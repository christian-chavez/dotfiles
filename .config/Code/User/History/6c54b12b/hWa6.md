...
Some thoughts: sheldon axler's linear algebra done right must be the go to reference to use for the course of advanced linear algebra (or the newer course: linear and multilinear algebra)
