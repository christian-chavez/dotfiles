...
En el diagrama anterior (\autoref{}) no hay características relevantes. No hay huecos que persistan con el tiempo. El conjunto de datos es ‘equivalente’ a un espacio topológico sin huecos: un punto.
