...
\begin{figure}[!htb]
    ...
    \caption{}\label{fig:ejemplo.diag.persistencia}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{figures/2024-02-02-16-57-42.png}
    \caption{}%\label{fig:}
\end{figure}

Importante. 
\begin{itemize}
    \item Los puntos que están cerca de la recta y=x representan ruido.
    \item Los puntos que están lejos de la recta y=x son características 
relevantes del conjunto de datos. Esta información es la que nos interesa.
\end{itemize}

En el diagrama anterior (\autoref{fig:ejemplo.diag.persistencia}) no hay características relevantes. No hay huecos que persistan con el tiempo. El conjunto de datos es ‘equivalente’ a un espacio topológico sin huecos: un punto.

El siguiente diagrama muestra que existe una característica relevante, a saber, que existe un hueco que persiste en el tiempo.

\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/2024-01-29-21-45-50.png}
