...
\begin{figure}[!htb]
    ...
    \caption{DEjemplo ilustrativo.  Diagrama de persistencia de la esfera. Cada punto en el diagrama corresponde a un rasgo topológico (basicamente un HUECO) }%\label{fig:}
\end{figure}
