...
\begin{enumerate}[label=\arabic*.]
    ...
    \item \textbf{The opposite category.} If \(\mathbf{C}\) is any category, we can build a new category denoted \(\mathbf{C}^{\text{op}}\) which has the same objects as \(\mathbf{C}\), but 
\end{enumerate}
\end{example}
