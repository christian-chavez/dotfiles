...
\begin{definition}[Isomorphism]
    A functor \(F\colon \mathbf{C}\to \mathbf{D}\) is an \textit{isomorphism} if there is a functor \(G\colon \mathbf{D}\to \mathbf{A}\) such that \(F\circ G = 1_{\mathbf{D}}\) and \(G\circ F = 1_{\mathbf{C}}\).
\end{definition}
