...
\begin{enumerate}[label=\arabic*.]
    ...
    \begin{description}[left=0.5\parindent,leftmargin=!,labelwidth=\widthof{\(\mathbf{\downdownarrows}i\)}] % ,, labelwidth=\parindent
        ...
        \item[\(\mathbf{\downdownarrows}\)] The  free-standing isomorphism is the category with exactly two objects and eactly two arrows with same domain and codomain. Such arrows are said to be \textit{parallel}. \red{no se llama así, no sé de donde lo saqué}
    \end{description}
