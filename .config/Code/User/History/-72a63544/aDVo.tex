...
\begin{theorem}
    ...
    \begin{enumerate}[label=(\roman*)]
        \item for each \(n\geq 0\) and  \(i\in [n]\), there is a map \(d_i\colon X_{n+1}\to X_n\), and
        \item for each \(n\geq 0\) and  \(i\in [n]\), there is a map \(s_i\colon X_{n}\to X_{n+1}\).
    \end{enumerate}
    Then there is a functor \(X\colon \Delta\to \mathbf{Set}\)
\end{theorem}
