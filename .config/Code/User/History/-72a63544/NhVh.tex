...
\begin{theorem}
    ...
    \begin{enumerate}[label=(\roman*)]
        \item For each \(n\geq 0\) and each \(i\in [n]\), there are maps \(d_i\colon X_{n+1}\to X_n\).
        \item For each \(n\geq 0\) and each \(i\in [n]\), there are maps \(s_i\colon X_{n}\to X_{n+1}\).
    \end{enumerate}
