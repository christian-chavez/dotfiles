...
By the last lemma, a contravariant functor from \(\Delta\) is completely characterized by where ut sends the objects  \([n]\)   and where it sends the coface and codegeneracy maps.
