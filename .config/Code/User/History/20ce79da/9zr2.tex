...
\renewcommand{\hom}{\DeclareMathOperator{command}{definition}}
...
% 2024-01-19 -----------------------------------
\setlist[itemize,enumerate,description]{topsep=0.0\baselineskip, itemsep=0.25\baselineskip}
...
% \newlength{\mylongest}
% \setlength{\mylongest}{}
% \addtolength{\widthof{\(\mathbf{\downdownarrows}\)}}{\labelsep}
