...
There were two presentation we had to prepare for this course. I chose to make the first one on  [cryptography](./media/presentationjs-cripto/index.html) and the latter on category theory.
