...
- **Book**: Abstract Algebra by Dummit & Foote. This is a very popular book and has tons of exercises. Some people even consider it to be an encyclopedia of algebra. Some other references are:
    ...
    - Abstract Algebra  by Herstein. A classic. Do not use it as an introductory textbook. It was funny to read [this](https://www.amazon.com/gp/customer-reviews/R1X7IQ8FAZ6HGM/ref=cm_cr_dp_d_rvw_ttl?ie=UTF8&ASIN=0471368792) review.
...
There were two presentation we had to made for this course. I chose to make the first one on  cryptography and the latter on category theory.
