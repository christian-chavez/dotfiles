...
I took this course last semester (2023, second semester) with Prof. Juan Mayorga. A good understanding of topology was crucial for taking this class, but also knowledge of Real Analysis and Linear Algebra.  We could cover all the material the professor had devised and more. The course was very well organized. [Here](https://drive.google.com/file/d/1zho8xn0V234D_U7TqIInsZ4hbxsqof5i/view?usp=sharing) you can find the syllabus.

This course is also supposed to be an introductory class on Functional Analysis. The main part of the course consist of the fundamental theorems of Functional Analysis. (Yes, they have  a special name.) It turns out 
