...
\subsubsubsection*{Complejos de Čech}
...
\subsubsubsection*{Complejos de Rips}
...
\subsubsubsection*{Nervio de $\mathcal{U}$}
...
\subsubsubsection*{Complejo de Delaunay}
...
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsubsection*{Complejo de Vietoris}
